...
## Create the histogram, with annotates
hist(data.EPC$Global_active_power, col="red",xlab="Global Active Power (kilowatts)", main="Global Active Power")

## Close the PNG file device
dev.off()

## View the file 'plot1.png' on the computer 
